...
That render writes [`docs/index.html`](../docs/index.html) plus `docs/assets/` and `docs/lecture_files/` (Reveal, theme, figures). The GitHub Actions workflow publishes `docs/` from `main`; the site root is the lecture, not this README.
...
Demonstration files and fallback instructions: [`workshops/README.md`](workshops/README.md).

```bash
pip install -r workshops/requirements.txt
python workshops/demo1_fallback.py
```
