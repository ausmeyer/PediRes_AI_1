...
::: notes
Full credential string if someone asks: MD, PhD, MS, MPH, MS. Canvas stays short. One hour. Live work is two blocks, not four separate shows. Take-home Labs 5–8 sit after Q&A and are not on the 60-minute clock. No PHI tonight. This is a survey, not a protocol — keep that in your voice, not as a punch on the title slide.
:::
...
![](assets/figures/poll_open.png){width="100%"}
...
::: notes
10-8-8-8-18-8. Take-home Labs 5–8 are not on this clock — say that out loud. Q&A eats slack at the end of the hour, after Lab 4. Live work is two blocks: Make → inspect, Ask → verify.
:::
...
## Same number, different child {.viz}

![](assets/figures/context_age.png){width="100%"}

::: notes
This replaces transformer anatomy. 38.5 °C in an 8-week-old is a workup clock. In an 8-year-old it is often watch-and-treat. Models need that context the same way you do. If they ask how attention works, the backup slide is after Q&A.
:::
...
![](assets/figures/three_eras.png){width="100%"}

::: notes
Autocomplete → chat → tools/checking. Names age quickly; these three jobs do not. Full chronology is in backup if someone wants GPT-2 through Fable.
:::
...
::: notes
Retrieve then generate. The corpus is the choice — that line is already on the artwork; point at it. Reduces some hallucinations. Does not stop wrong-paper, unsupported synthesis, leftover parametric claims, or citation theater. OpenEvidence, UpToDate, and ChatGPT-with-search are different libraries.
:::
...
::: notes
Not human reasoning. Left column is “answer once”: ship =B2*10. Right column is try → test → revise, the way you want a harness to behave in Lab 2. o1 (Sep 2024) made that loop the product. Coding evals moved because you can grade code.
:::
...
::: notes
Board-style exams and vendor tables are a test with a key, comparable across models. This infant, this formulary, and this family’s language are not. Keep the phrase “this child, tonight.” High scores do not travel to weight-based dosing. FDA 2026 paper is still asking how to test open-ended generative AI.
:::
...
::: notes
Consumer cloud / hospital-governed cloud / local laptop. Do not recatalog model names. Phone app = no BAA. Hospital tool with a contract is the official cloud path. Laptop Ollama: the vendor never sees the prompt, and they already use that laptop for the EHR.
:::
...
::: notes
Artsi 2026 OpenEvidence systematic review. End on the line already on the figure: search assistant, not pediatric guideline. Company “40% of US physicians” is vendor-reported. Registry: PROSPERO CRD420261289103. Do not invent a pediatric evidence base from 11 adult-leaning studies.
:::

---

## A citation is not proof of correctness {.viz}

![](assets/figures/hajj_counterexample.png){width="100%"}

::: notes
Hajj inside Artsi: ChatGPT-4o 66.7 vs OpenEvidence 26.7 on 15 adult transcatheter tricuspid questions. n=15 is the whole study. Do not present it as pediatric. Heuristic: OE for journals, UpToDate for the editorial corpus you already pay for, neither for “what do I do without looking.”
:::

---

## Settled / unsettled {.viz}

![](assets/figures/settled.png){width="100%"}

::: notes
As of August 2026. Humans remain accountable. Transparency is increasing. Pediatric-specific policy is incomplete — do not invent an AAP clinical AI guideline. The dated chronology is in backup if someone wants January-to-August names.
:::
...
![](assets/figures/two_blocks.png){width="100%"}
...
![](assets/figures/formula_bug.png){width="88%"}
...
## Check the answer {.qa-close .nostretch}
...
![](assets/figures/lab5_flow.png){width="100%"}
...
![](assets/figures/lab6_rules.png){width="100%"}
