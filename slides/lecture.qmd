...
::: notes
Decoder-style LLM: given the tokens so far, score the next one, add it, repeat. The mix-then-update stack is a transformer. Cartoon, not a measured head or a real softmax table. Next slide zooms on the mix.
:::
...
::: notes
Self-attention, 2017. This is the mix step from the last slide. Cartoon: one token looking at the sentence with straight arrows. Not a measured attention head. Point: context, not magic understanding.
:::
...
::: notes
Not human reasoning. Try several answers at answer time and keep one that checks out. o1 (Sep 2024) made that the product. Coding evals moved because you can grade code. That pulled computer-use and harnesses. The curve is a cartoon, not a vendor eval.
:::
